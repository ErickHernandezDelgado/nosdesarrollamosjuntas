...
const db = mysql.createConnection({
    ...
    user: "root",
    password: "1234",
    database: "nosdesarrollamosjuntas"
});
...
app.post("/registro", (req, res) => {
    ...
    const menarquia = primerPeriodo ? 1 : 0;

    const sqlUsuario = "INSERT INTO usuarios (nombre, apellido, contraseña, edad, menarquia) VALUES (?, ?, ?, ?, ?)";
...
app.post("/login", (req, res) => {
    ...
    const sql = `
        ...
        WHERE u.nombre = ? AND u.apellido = ? AND u.contraseña = ?
    `;
